...
export default function Home(params) {
  //keeps track weather users wallet is connected or not
  ...
  const addAddressToWhitelist = async () => {
    try {
      ...
      const tx = await whitelistContract.addAddressToWhileList();
      setLoading(true);
  ...
  */
  ...
  return (
    <div>
      ...
      <footer className=''>Made with &#10084; by Crypto Devs</footer>
    </div>
  );
}
